...
setup(
    name='CyvoreOS',
    packages=['CyvoreOS', 'CyvoreOS\\Plugins', 'CyvoreOS\\Output', 'CyvoreOS\\interfaces'],
    version='0.1.7',
    ...
    download_url='https://github.com/barakinio/CyvoreOS/archive/refs/tags/v_0.1.7.tar.gz',  # Release Link
